  ...
  render: function () {
    ...
    return (
      <div className="signal-with-sequence-container">
        ...
        <LinearGraph data={signal} width={800} height={300} withoutBrush={true} emulateBars={true} emulateBinary={true} xAxisTitle={'t, c'}/>
        ...
        <LinearGraph data={sequence} width={800} height={300} emulateBars={true} emulateBinary={true} xAxisTitle={'t, c'}/>
        ...
        <LinearGraph data={signalWithSequence} width={800} height={300} emulateBars={true}  emulateBinary={true} xAxisTitle={'t, c'} dividend={signalWithSequence.length / signal.length}/>
        <p className="text-center">{texts.signalWithSequence.signalWithSequenceCapture}</p>

        <LinearGraph data={spreadSignalSpectrum} width={800} height={300} emulateBars={true} xAxisTitle={'f, Гц'} yAxisTitle={'A'}/>
