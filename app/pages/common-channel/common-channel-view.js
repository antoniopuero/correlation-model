  ...
  render: function () {
    ...
    return (
      <div className="common-channel-container">
        ...
        <LinearGraph data={firstSignalOnCarrier} width={800} height={300} xAxisTitle={'t, c'} dividend={firstSignalOnCarrier.length / 5}/>
        <p className="text-center">{texts.commonChannel.firstSignalOnCarrierCapture}</p>
        <LinearGraph data={secondSignalOnCarrier} width={800} height={300} xAxisTitle={'t, c'} dividend={secondSignalOnCarrier.length / 5}/>
