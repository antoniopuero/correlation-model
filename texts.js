...
module.exports = {
  ...
  sequenceGuessing: {
    ...
    firstSequencePolynomial: 'Формуючий поліном першого сигналу',
    secondSequencePolynomial: 'Формуючий поліном першого сигналу'
  },
  signalOnCarrier: {
    heading: 'Модуляція несучої',
    introPart: '<p>Після того як сигнал було закодовано методом прямої послідовності його необхідно підготовити для передачі в реальних системах зв\'язку. Під цим позуміється нанесення на високочастотну несучу що дозволить передавати на далекі відстані (низькочастотні сигнали не здатні поширюватись на далекі відстані через низький рівень енергії).</p><p>Для того щоб нанести сигнал на несучу його необхідно трансформувати. Трансформація полягає перетворенні двійкової одиниці в -1, а двійкового нуля в 1. Перетворений сигнал зображено на графіку 6. Але основна ідея в тому що при нанесенні двійкового сигналу на синусоїду в термінах "1, 0" ми отримаємо або синусоїду або нічого (нанесення сигналу на синусоїду використовує операціє множення), а в термінах "-1, 1" ми отримаємо або пряму або інвертовану синусоїду. В місцях де -1 чергується з 1 можна побачити стрибок фази (пряма синусоїда міняє інвертовану і т.д.). Отриманий сигнал називається BPSK (binary phase shifting key) сигнал. BPSK - найпростіша форма фазової маніпуляції сигналу, але в даному найпростіша значить ще й найточніша, що добре складується з сигналами GPS - об\'єм інформаційного повідомлення невеликий але має бути точно визначеним на детекторі.</p>',
    signalWithSequenceCapture: 'Граф. 5, Закодований сигнал',
    aboutCarrying: 'На принциповій схемі зображено які компоненти приймають участь в моделюванні несучої: це результуючий сигнал після додавання по модулю два псевдовипадкової послідовності з кожним бітом інформаційної послідовності та згенерована синусоїда з генератора несучої. Як правило частота несучої набагато більша за частоту псевдошумового сигналу, для прикладу в GPS частота несучої 1.5 ГГц а сигналу 1 МГц. В даній роботі взято відношення частот таким чином щоб в один біт інформаційної послідовності потрапляв рівно один період несучої. На графіку 6 зображено Промодульовану псевдовипадковим сигналом несучу. Можна використати зумер внизу графіку щоб детально роздивитись фазові переходи.',
    transformedSignalCaption: 'Граф. 6, перетворений сигнал із термінів "1 0" в "-1 1"',
    carrierCaption: 'Граф. 7, Несуча, гармонічний сигнал',
    signalOnCarrierCapture: 'Граф. 8, Промодульована несуча, BPSK сигнал'
  },
  signalWithSequence: {
    ...
    signalWithSequenceCapture: 'Граф. 3, Бітовий інформаційний сигнал нанесений на м-послідовність',
    signalWithSequenceSpectrumCapture: 'Граф. 4, Спектр сигналу нанесеного на м-послідовність',
